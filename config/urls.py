...
from fudee.users.views import email_confirmed_view
...
urlpatterns = [
    ...
    path('rest-auth/registration/account-confirm-email/<str:key>/', TemplateView.as_view(template_name="account/email_confirmed.html"), name="email_confirmed"),
